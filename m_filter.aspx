<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m_filter.aspx.cs" Inherits="final.f" %>
...
<div id="container">
       <script>
           ...
           var 图标 = new BMapGL.Icon("images/图例.png", new BMapGL.Size(140, 250));
           var tubiao = new BMapGL.Point(108.43511738550767, 34.344986800969416);
           var mark = new BMapGL.Marker(tubiao, { icon: 图标 })
           /*map.addOverlay(mark);*/

             <% 
           string sqlstr = Session["sql"].ToString();
           List<YF.Model.Map> list = YF.BLL.Map.filter(sqlstr);
             %>
